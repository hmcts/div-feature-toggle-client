...
This project is a new divorce filing application, which aims to make petitions quicker and less stressful.
...
or we may ask you to make some additional amendments before incorporating it into the main branch.CONTRIBUTING.md